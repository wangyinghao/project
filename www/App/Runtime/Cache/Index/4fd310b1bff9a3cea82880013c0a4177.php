...
<title><?php echo ($put); ?>-<?php echo R('Siteinfo/info',array('title'),'Widget');?></title>
    ...
    <div class="col-lg-8 col-md-8 content">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h1 class="pull-left" itemprop="headline">为您找到<span style="color:red"> <?php echo ($put); ?> </span>的相关内容</h1>
        ...
        <div class="panel-footer text-muted"> 为您找到与“<?php echo ($put); ?>”有关的结果 <?php echo ($count); ?>个</div>
      </div>
      <?php echo ($show); ?>
  ...
  <div class="col-lg-4 col-md-4 sidebar">
    ...
    <div class="panel-group mb20" id="accordion">
      <div class="panel panel-danger">
        <div class="panel-heading">
          <h3 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" class="collapsed"> <span class="glyphicon glyphicon-fire mr10"></span> <span itemprop="name">按浏览次数推荐的5篇</span> </a> </h3>
        </div>
